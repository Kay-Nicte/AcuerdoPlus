...
const styles = StyleSheet.create({
  ...
  readOnlyField: { backgroundColor: COLORS.backgroundSecondary, borderRadius: 12, padding: SPACING.md },
  ...
  optionChip: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 12, paddingVertical: SPACING.sm, paddingHorizontal: SPACING.md },
  optionChipSelected: { borderColor: COLORS.primary, backgroundColor: COLORS.primaryPale },
  ...
  button: { backgroundColor: COLORS.primary, padding: 14, borderRadius: 12, alignItems: 'center', marginTop: SPACING.xl },
